...
ای پی مارت اس اس اچ پنل یک نرم افزار تحت وب جهت مدیریت اکانت SSH می باشد.
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ipmartnetwork/iPmart-SSH/main/install.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ipmartnetwork/iPmart-SSH/main/update-panel.sh --ipv4)
```
## فعال سازی SSL

```
bash <(curl -Ls https://raw.githubusercontent.com/ipmartnetwork/iPmart-SSH/main/ssl.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ipmartnetwork/iPmart-SSH/main/block-ir-ip.sh --ipv4)
```
